...
<body>
  <h2><marquee>Some Intresting Facts about Blood Donation </marquee></h2>
    <td valign="top"><p class="heading_color"><strong>Facts about blood needs</strong></p>
        <ul>
          ...
          blood.<img src="blood_3.jpg" width="290" height="100" align="right"></li>
        ...
        <p class="heading_color"><strong>Facts about the blood supply</strong></p>
        <ul>
          <li>Blood cannot be manufactured – it can only come from generous donors.<img src="blood_4.jpg" width="290" height="100" align="right"></li>
        ...
        <p class="heading_color"><strong>Facts about the blood donation process</strong></p>
        <ul>
          <li>Donating blood is a safe process. A sterile needle is used only once for each donor and then discarded.<img src="blood_1.jpg" width="290" height="100" align="right"></li>
          ...
          <li>The average adult has about 10 units of blood in his body. Roughly 1 unit is given during a donation.<img src="blood_2.jpg" width="290" height="100" align="right"></li>
        ...
        <p class="heading_color"><strong>Facts about donors </strong></p>
        <ul>
          ...
          <li>One donation can help save the lives of up to&nbsp;three people.<img src="blood_5.jpg" width="290" height="100" align="right"></li>
...
</html> will not get AIDS if you donate blood.<br>
7.Patients are just like donors - most of them have common blood types. Because your blood type is common, the demand for that type is greater than for rare types. So, even if your blood type is common there is still a requirement.</p1>
</body>
</html>s